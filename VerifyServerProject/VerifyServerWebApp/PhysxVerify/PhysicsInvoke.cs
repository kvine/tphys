...
namespace AuthServer.PhysxVerify
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct RayCastHitExtend
    {
    ...
    public class PhysicsInvoke
    {
        ...
        /// <returns></returns>
        [DllImport("libVerifyLibrary")]
        static extern IntPtr RaycastHit(IntPtr ptrSimulateMgr, PxVec3 origin, PxVec3 unitDir, float distance, int layerMask);
        ...
        /// <returns></returns>
        [DllImport("libVerifyLibrary")]
        static extern IntPtr SphereCast(IntPtr ptrSimulateMgr, float radius, PxVec3 pOrigin, PxVec3 pDir, float distance, int layerMask);
        ...
        public static IntPtr RaycastHitCall(IntPtr ptrSimulateMgr, PxVec3 origin, PxVec3 unitDir, float dis, int layerMask)
        {
            IntPtr pHitExtend = RaycastHit(ptrSimulateMgr, origin, unitDir, dis, layerMask);
            return pHitExtend;
            // return RaycastHit(ptrSimulateMgr, origin, unitDir, dis, layerMask);
        }

        public static IntPtr SphereRaycastHitCall(IntPtr ptrSimulateMgr, float radius, PxVec3 origin, PxVec3 unitDir, float dis, int layerMask)
        {
            IntPtr pHitExtend = SphereCast(ptrSimulateMgr, radius, origin, unitDir, dis, layerMask);
            return pHitExtend;
            // return SphereCast(ptrSimulateMgr, radius, origin, unitDir, dis, layerMask);
        }
        ...
        public static IntPtr createVerifyMgr(){
            return CreateVerifyMgr();
        }
    }
    ...
    public class VerifyMgrProxy
    {
        ...
        private VerifyMgrProxy(){
            ptrVerifyMgr = PhysicsInvoke.createVerifyMgr();
        }
